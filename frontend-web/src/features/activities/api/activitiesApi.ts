...
export const ActivitiesApi = {
  ...
  async deleteClub(clubId: number): Promise<Club> {
    const data = await ApiClient.post(`/activities/clubs/${clubId}/delete`, {});
    return clubFromJson(data);
  },
  ...
  async participateEvent(eventId: number): Promise<ActivityEvent> {
    const data = await ApiClient.post(`/activities/events/${eventId}/participate`, {});
    return eventFromJson(data);
  },

  async leaveEvent(eventId: number): Promise<ActivityEvent> {
    const data = await ApiClient.post(`/activities/events/${eventId}/leave`, {});
    return eventFromJson(data);
  },
  ...
  async deleteEvent(eventId: number): Promise<ActivityEvent> {
    const data = await ApiClient.post(`/activities/events/${eventId}/delete`, {});
    return eventFromJson(data);
  },
