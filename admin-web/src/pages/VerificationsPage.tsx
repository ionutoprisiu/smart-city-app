...
const SECTIONS: { key: SectionKey; title: string; description: string }[] = [
  {
    key: "MANUAL_REVIEW",
    title: "In review",
    description: "Score ≥ 0.55 or quality that requires manual review",
  },
  {
    key: "REJECTED",
    title: "Rejected",
    description: "Score below 0.55; admin may still approve manually if appropriate",
  },
  {
    key: "APPROVED",
    title: "Approved",
    description: "Verifications confirmed by admin",
  },
];
